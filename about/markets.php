...
<body>
	...
	<section class="darkGreen center" style="padding:2.5em 0px .5em 0px;font-size:16pt">
		...
		<H1 style="font-size:40pt">Who Uses EasyRegPro?</H1>
		<p style="margin-bottom: 0px;">
			Due to it's amazingly simple design, EasyRegPro is used and can be used for events of any and all types. Let EasyRegPro work for you!
		</p>
	</section>
